...
void RDrawParms::ZoomRect(int ileft, int itop, int iright, int ibottom, bool bZoomIn/*=true*/)//; // 框选放大
{
	// 1. 求出框选范围的视口（设备）中心点
...
void RDrawParms::MPtoDP(double dx, double dy, double* ix, double* iy) // 地图坐标——》设备坐标
{
#ifdef use_affine_trans
	agg::trans_affine mtx=m_mtx;
